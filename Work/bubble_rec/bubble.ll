...
if.then5:                                         ; preds = %for.body
  ...
  call void @_ZSt4swapIiEvRT_S1_(i32* %arrayidx7, i32* %arrayidx10)
  br label %if.end11
...
for.end:                                          ; preds = %for.cond
  %14 = load i32** %arr.addr, align 8
  %15 = load i32* %n.addr, align 4
  %sub12 = sub nsw i32 %15, 1
  call void @_Z10bubbleSortPii(i32* %14, i32 %sub12)
  br label %return
...
entry:
  ...
  %4 = load i32** %__a.addr, align 8
  store i32 %3, i32* %4, align 4
  %5 = load i32* %__tmp, align 4
  %6 = load i32** %__b.addr, align 8
