...
entry:
  ...
  %cmp = icmp eq i32 %0, 1, !llfi_index !12
  call void @doProfiling(i32 46)
  br i1 %cmp, label %if.then, label %if.end, !llfi_index !13

if.then:                                          ; preds = %entry
  br label %return, !llfi_index !14

if.end:                                           ; preds = %entry
  store i32 0, i32* %i, align 4, !llfi_index !15
  br label %for.cond, !llfi_index !16

for.cond:                                         ; preds = %for.inc, %if.end
  %1 = load i32* %i, align 4, !llfi_index !17
  call void @doProfiling(i32 27)
  %2 = load i32* %n.addr, align 4, !llfi_index !18
  call void @doProfiling(i32 27)
  %sub = sub nsw i32 %2, 1, !llfi_index !19
  call void @doProfiling(i32 10)
  %cmp1 = icmp slt i32 %1, %sub, !llfi_index !20
  call void @doProfiling(i32 46)
  br i1 %cmp1, label %for.body, label %for.end, !llfi_index !21

for.body:                                         ; preds = %for.cond
  %3 = load i32* %i, align 4, !llfi_index !22
  call void @doProfiling(i32 27)
  %idxprom = sext i32 %3 to i64, !llfi_index !23
  call void @doProfiling(i32 35)
  %4 = load i32** %arr.addr, align 8, !llfi_index !24
  call void @doProfiling(i32 27)
  %arrayidx = getelementptr inbounds i32* %4, i64 %idxprom, !llfi_index !25
  call void @doProfiling(i32 29)
  %5 = load i32* %arrayidx, align 4, !llfi_index !26
  call void @doProfiling(i32 27)
  %6 = load i32* %i, align 4, !llfi_index !27
  call void @doProfiling(i32 27)
  %add = add nsw i32 %6, 1, !llfi_index !28
  call void @doProfiling(i32 8)
  %idxprom2 = sext i32 %add to i64, !llfi_index !29
  call void @doProfiling(i32 35)
  %7 = load i32** %arr.addr, align 8, !llfi_index !30
  call void @doProfiling(i32 27)
  %arrayidx3 = getelementptr inbounds i32* %7, i64 %idxprom2, !llfi_index !31
  call void @doProfiling(i32 29)
  %8 = load i32* %arrayidx3, align 4, !llfi_index !32
  call void @doProfiling(i32 27)
  %cmp4 = icmp sgt i32 %5, %8, !llfi_index !33
  call void @doProfiling(i32 46)
  br i1 %cmp4, label %if.then5, label %if.end11, !llfi_index !34

if.then5:                                         ; preds = %for.body
  %9 = load i32* %i, align 4, !llfi_index !35
  call void @doProfiling(i32 27)
  %idxprom6 = sext i32 %9 to i64, !llfi_index !36
  call void @doProfiling(i32 35)
  %10 = load i32** %arr.addr, align 8, !llfi_index !37
  call void @doProfiling(i32 27)
  %arrayidx7 = getelementptr inbounds i32* %10, i64 %idxprom6, !llfi_index !38
  call void @doProfiling(i32 29)
  %11 = load i32* %i, align 4, !llfi_index !39
  call void @doProfiling(i32 27)
  %add8 = add nsw i32 %11, 1, !llfi_index !40
  call void @doProfiling(i32 8)
  %idxprom9 = sext i32 %add8 to i64, !llfi_index !41
  call void @doProfiling(i32 35)
  %12 = load i32** %arr.addr, align 8, !llfi_index !42
  call void @doProfiling(i32 27)
  %arrayidx10 = getelementptr inbounds i32* %12, i64 %idxprom9, !llfi_index !43
  call void @doProfiling(i32 29)
  call void @_ZSt4swapIiEvRT_S1_(i32* %arrayidx7, i32* %arrayidx10), !llfi_index !44
  br label %if.end11, !llfi_index !45

if.end11:                                         ; preds = %if.then5, %for.body
  br label %for.inc, !llfi_index !46

for.inc:                                          ; preds = %if.end11
  %13 = load i32* %i, align 4, !llfi_index !47
  call void @doProfiling(i32 27)
  %inc = add nsw i32 %13, 1, !llfi_index !48
  call void @doProfiling(i32 8)
  store i32 %inc, i32* %i, align 4, !llfi_index !49
  br label %for.cond, !llfi_index !50

for.end:                                          ; preds = %for.cond
  %14 = load i32** %arr.addr, align 8, !llfi_index !51
  call void @doProfiling(i32 27)
  %15 = load i32* %n.addr, align 4, !llfi_index !52
  call void @doProfiling(i32 27)
  %sub12 = sub nsw i32 %15, 1, !llfi_index !53
  call void @doProfiling(i32 10)
  call void @_Z10bubbleSortPii(i32* %14, i32 %sub12), !llfi_index !54
  br label %return, !llfi_index !55
...
entry:
  %__a.addr = alloca i32*, align 8, !llfi_index !57
  %__b.addr = alloca i32*, align 8, !llfi_index !58
  %__tmp = alloca i32, align 4, !llfi_index !59
  store i32* %__a, i32** %__a.addr, align 8, !llfi_index !60
  store i32* %__b, i32** %__b.addr, align 8, !llfi_index !61
  %0 = load i32** %__a.addr, align 8, !llfi_index !62
  call void @doProfiling(i32 27)
  %1 = load i32* %0, align 4, !llfi_index !63
  call void @doProfiling(i32 27)
  store i32 %1, i32* %__tmp, align 4, !llfi_index !64
  %2 = load i32** %__b.addr, align 8, !llfi_index !65
  call void @doProfiling(i32 27)
  %3 = load i32* %2, align 4, !llfi_index !66
  call void @doProfiling(i32 27)
  %4 = load i32** %__a.addr, align 8, !llfi_index !67
  call void @doProfiling(i32 27)
  store i32 %3, i32* %4, align 4, !llfi_index !68
  %5 = load i32* %__tmp, align 4, !llfi_index !69
  call void @doProfiling(i32 27)
  %6 = load i32** %__b.addr, align 8, !llfi_index !70
  call void @doProfiling(i32 27)
  store i32 %5, i32* %6, align 4, !llfi_index !71
...
entry:
  %arr.addr = alloca i32*, align 8, !llfi_index !73
  %n.addr = alloca i32, align 4, !llfi_index !74
  %i = alloca i32, align 4, !llfi_index !75
  store i32* %arr, i32** %arr.addr, align 8, !llfi_index !76
  store i32 %n, i32* %n.addr, align 4, !llfi_index !77
  store i32 0, i32* %i, align 4, !llfi_index !78
  br label %for.cond, !llfi_index !79

for.cond:                                         ; preds = %for.inc, %entry
  %0 = load i32* %i, align 4, !llfi_index !80
  call void @doProfiling(i32 27)
  %1 = load i32* %n.addr, align 4, !llfi_index !81
  call void @doProfiling(i32 27)
  %cmp = icmp slt i32 %0, %1, !llfi_index !82
  call void @doProfiling(i32 46)
  br i1 %cmp, label %for.body, label %for.end, !llfi_index !83

for.body:                                         ; preds = %for.cond
  %2 = load i32* %i, align 4, !llfi_index !84
  call void @doProfiling(i32 27)
  %idxprom = sext i32 %2 to i64, !llfi_index !85
  call void @doProfiling(i32 35)
  %3 = load i32** %arr.addr, align 8, !llfi_index !86
  call void @doProfiling(i32 27)
  %arrayidx = getelementptr inbounds i32* %3, i64 %idxprom, !llfi_index !87
  call void @doProfiling(i32 29)
  %4 = load i32* %arrayidx, align 4, !llfi_index !88
  call void @doProfiling(i32 27)
  %call = call %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %4), !llfi_index !89
  %call1 = call %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* %call, i8* getelementptr inbounds ([2 x i8]* @.str, i32 0, i32 0)), !llfi_index !90
  br label %for.inc, !llfi_index !91

for.inc:                                          ; preds = %for.body
  %5 = load i32* %i, align 4, !llfi_index !92
  call void @doProfiling(i32 27)
  %inc = add nsw i32 %5, 1, !llfi_index !93
  call void @doProfiling(i32 8)
  store i32 %inc, i32* %i, align 4, !llfi_index !94
...
define i32 @main() #2 {
entry:
  %retval = alloca i32, align 4, !llfi_index !97
  %arr = alloca [1000 x i32], align 16, !llfi_index !98
  %n = alloca i32, align 4, !llfi_index !99
  store i32 0, i32* %retval, !llfi_index !100
  %0 = bitcast [1000 x i32]* %arr to i8*, !llfi_index !101
  call void @doProfiling(i32 44)
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %0, i8* bitcast ([1000 x i32]* @_ZZ4mainE3arr to i8*), i64 4000, i32 16, i1 false), !llfi_index !102
  store i32 1000, i32* %n, align 4, !llfi_index !103
  %arraydecay = getelementptr inbounds [1000 x i32]* %arr, i32 0, i32 0, !llfi_index !104
  call void @doProfiling(i32 29)
  %1 = load i32* %n, align 4, !llfi_index !105
  call void @doProfiling(i32 27)
  call void @_Z10bubbleSortPii(i32* %arraydecay, i32 %1), !llfi_index !106
  %arraydecay1 = getelementptr inbounds [1000 x i32]* %arr, i32 0, i32 0, !llfi_index !107
  call void @doProfiling(i32 29)
  %2 = load i32* %n, align 4, !llfi_index !108
  call void @doProfiling(i32 27)
  call void @_Z8printArrPii(i32* %arraydecay1, i32 %2), !llfi_index !109
  call void @endProfiling()
  ret i32 0, !llfi_index !110
}
...
entry:
  call void @__cxx_global_var_init(), !llfi_index !111
