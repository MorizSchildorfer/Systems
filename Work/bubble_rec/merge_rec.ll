...
if.then:                                          ; preds = %entry
  ...
  %14 = load i32* %r.addr, align 4
  call void @_Z5mergePiiii(i32* %11, i32 %12, i32 %13, i32 %14)
  br label %if.end
...
while.body:                                       ; preds = %land.end
  ...
  %32 = load i32* %arrayidx23, align 4
  %33 = load i32* %j19, align 4
  %idxprom24 = sext i32 %33 to i64
  %arrayidx25 = getelementptr inbounds i32* %vla2, i64 %idxprom24
...
if.then:                                          ; preds = %while.body
  ...
  %36 = load i32* %arrayidx28, align 4
...
while.body40:                                     ; preds = %while.cond38
  %48 = load i32* %i18, align 4
  %idxprom41 = sext i32 %48 to i64
  %arrayidx42 = getelementptr inbounds i32* %vla, i64 %idxprom41
  %49 = load i32* %arrayidx42, align 4
  ...
  %52 = load i32* %i18, align 4
  %inc45 = add nsw i32 %52, 1
  store i32 %inc45, i32* %i18, align 4
...
while.body50:                                     ; preds = %while.cond48
  %56 = load i32* %j19, align 4
  %idxprom51 = sext i32 %56 to i64
  %arrayidx52 = getelementptr inbounds i32* %vla2, i64 %idxprom51
  %57 = load i32* %arrayidx52, align 4
  %58 = load i32* %k, align 4
  %idxprom53 = sext i32 %58 to i64
  %59 = load i32** %arr.addr, align 8
  %arrayidx54 = getelementptr inbounds i32* %59, i64 %idxprom53
  store i32 %57, i32* %arrayidx54, align 4
  %60 = load i32* %j19, align 4
  %inc55 = add nsw i32 %60, 1
  store i32 %inc55, i32* %j19, align 4
