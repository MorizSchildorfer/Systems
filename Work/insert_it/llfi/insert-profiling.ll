...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %1 = load i32* %n.addr, align 4, !llfi_index !16
  call void @doProfiling(i32 27)
  %cmp = icmp slt i32 %0, %1, !llfi_index !17
  call void @doProfiling(i32 46)
  br i1 %cmp, label %for.body, label %for.end, !llfi_index !18

for.body:                                         ; preds = %for.cond
  %2 = load i32* %i, align 4, !llfi_index !19
  call void @doProfiling(i32 27)
  %idxprom = sext i32 %2 to i64, !llfi_index !20
  call void @doProfiling(i32 35)
  %3 = load i32** %arr.addr, align 8, !llfi_index !21
  call void @doProfiling(i32 27)
  %arrayidx = getelementptr inbounds i32* %3, i64 %idxprom, !llfi_index !22
  call void @doProfiling(i32 29)
  %4 = load i32* %arrayidx, align 4, !llfi_index !23
  call void @doProfiling(i32 27)
  store i32 %4, i32* %key, align 4, !llfi_index !24
  %5 = load i32* %i, align 4, !llfi_index !25
  call void @doProfiling(i32 27)
  %sub = sub nsw i32 %5, 1, !llfi_index !26
  call void @doProfiling(i32 10)
  store i32 %sub, i32* %j, align 4, !llfi_index !27
  br label %while.cond, !llfi_index !28

while.cond:                                       ; preds = %while.body, %for.body
  %6 = load i32* %j, align 4, !llfi_index !29
  call void @doProfiling(i32 27)
  %cmp1 = icmp sge i32 %6, 0, !llfi_index !30
  call void @doProfiling(i32 46)
  br i1 %cmp1, label %land.rhs, label %land.end, !llfi_index !31

land.rhs:                                         ; preds = %while.cond
  %7 = load i32* %j, align 4, !llfi_index !32
  call void @doProfiling(i32 27)
  %idxprom2 = sext i32 %7 to i64, !llfi_index !33
  call void @doProfiling(i32 35)
  %8 = load i32** %arr.addr, align 8, !llfi_index !34
  call void @doProfiling(i32 27)
  %arrayidx3 = getelementptr inbounds i32* %8, i64 %idxprom2, !llfi_index !35
  call void @doProfiling(i32 29)
  %9 = load i32* %arrayidx3, align 4, !llfi_index !36
  call void @doProfiling(i32 27)
  %10 = load i32* %key, align 4, !llfi_index !37
  call void @doProfiling(i32 27)
  %cmp4 = icmp sgt i32 %9, %10, !llfi_index !38
  call void @doProfiling(i32 46)
  br label %land.end, !llfi_index !39

land.end:                                         ; preds = %land.rhs, %while.cond
  %11 = phi i1 [ false, %while.cond ], [ %cmp4, %land.rhs ], !llfi_index !40
  br i1 %11, label %while.body, label %while.end, !llfi_index !41

while.body:                                       ; preds = %land.end
  %12 = load i32* %j, align 4, !llfi_index !42
  call void @doProfiling(i32 27)
  %idxprom5 = sext i32 %12 to i64, !llfi_index !43
  call void @doProfiling(i32 35)
  %13 = load i32** %arr.addr, align 8, !llfi_index !44
  call void @doProfiling(i32 27)
  %arrayidx6 = getelementptr inbounds i32* %13, i64 %idxprom5, !llfi_index !45
  call void @doProfiling(i32 29)
  %14 = load i32* %arrayidx6, align 4, !llfi_index !46
  call void @doProfiling(i32 27)
  %15 = load i32* %j, align 4, !llfi_index !47
  call void @doProfiling(i32 27)
  %add = add nsw i32 %15, 1, !llfi_index !48
  call void @doProfiling(i32 8)
  %idxprom7 = sext i32 %add to i64, !llfi_index !49
  call void @doProfiling(i32 35)
  %16 = load i32** %arr.addr, align 8, !llfi_index !50
  call void @doProfiling(i32 27)
  %arrayidx8 = getelementptr inbounds i32* %16, i64 %idxprom7, !llfi_index !51
  call void @doProfiling(i32 29)
  store i32 %14, i32* %arrayidx8, align 4, !llfi_index !52
  %17 = load i32* %j, align 4, !llfi_index !53
  call void @doProfiling(i32 27)
  %sub9 = sub nsw i32 %17, 1, !llfi_index !54
  call void @doProfiling(i32 10)
  store i32 %sub9, i32* %j, align 4, !llfi_index !55
  br label %while.cond, !llfi_index !56

while.end:                                        ; preds = %land.end
  %18 = load i32* %key, align 4, !llfi_index !57
  call void @doProfiling(i32 27)
  %19 = load i32* %j, align 4, !llfi_index !58
  call void @doProfiling(i32 27)
  %add10 = add nsw i32 %19, 1, !llfi_index !59
  call void @doProfiling(i32 8)
  %idxprom11 = sext i32 %add10 to i64, !llfi_index !60
  call void @doProfiling(i32 35)
  %20 = load i32** %arr.addr, align 8, !llfi_index !61
  call void @doProfiling(i32 27)
  %arrayidx12 = getelementptr inbounds i32* %20, i64 %idxprom11, !llfi_index !62
  call void @doProfiling(i32 29)
  store i32 %18, i32* %arrayidx12, align 4, !llfi_index !63
  br label %for.inc, !llfi_index !64

for.inc:                                          ; preds = %while.end
  %21 = load i32* %i, align 4, !llfi_index !65
  call void @doProfiling(i32 27)
  %inc = add nsw i32 %21, 1, !llfi_index !66
  call void @doProfiling(i32 8)
  store i32 %inc, i32* %i, align 4, !llfi_index !67
  br label %for.cond, !llfi_index !68
...
entry:
  %arr.addr = alloca i32*, align 8, !llfi_index !70
  %n.addr = alloca i32, align 4, !llfi_index !71
  %i = alloca i32, align 4, !llfi_index !72
  store i32* %arr, i32** %arr.addr, align 8, !llfi_index !73
  store i32 %n, i32* %n.addr, align 4, !llfi_index !74
  store i32 0, i32* %i, align 4, !llfi_index !75
  br label %for.cond, !llfi_index !76

for.cond:                                         ; preds = %for.inc, %entry
  %0 = load i32* %i, align 4, !llfi_index !77
  call void @doProfiling(i32 27)
  %1 = load i32* %n.addr, align 4, !llfi_index !78
  call void @doProfiling(i32 27)
  %cmp = icmp slt i32 %0, %1, !llfi_index !79
  call void @doProfiling(i32 46)
  br i1 %cmp, label %for.body, label %for.end, !llfi_index !80

for.body:                                         ; preds = %for.cond
  %2 = load i32* %i, align 4, !llfi_index !81
  call void @doProfiling(i32 27)
  %idxprom = sext i32 %2 to i64, !llfi_index !82
  call void @doProfiling(i32 35)
  %3 = load i32** %arr.addr, align 8, !llfi_index !83
  call void @doProfiling(i32 27)
  %arrayidx = getelementptr inbounds i32* %3, i64 %idxprom, !llfi_index !84
  call void @doProfiling(i32 29)
  %4 = load i32* %arrayidx, align 4, !llfi_index !85
  call void @doProfiling(i32 27)
  %call = call %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %4), !llfi_index !86
  %call1 = call %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* %call, i8* getelementptr inbounds ([2 x i8]* @.str, i32 0, i32 0)), !llfi_index !87
  br label %for.inc, !llfi_index !88

for.inc:                                          ; preds = %for.body
  %5 = load i32* %i, align 4, !llfi_index !89
  call void @doProfiling(i32 27)
  %inc = add nsw i32 %5, 1, !llfi_index !90
  call void @doProfiling(i32 8)
  store i32 %inc, i32* %i, align 4, !llfi_index !91
  br label %for.cond, !llfi_index !92

for.end:                                          ; preds = %for.cond
  %call2 = call %"class.std::basic_ostream"* @_ZNSolsEPFRSoS_E(%"class.std::basic_ostream"* @_ZSt4cout, %"class.std::basic_ostream"* (%"class.std::basic_ostream"*)* @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_), !llfi_index !93
...
define i32 @main() #3 {
entry:
  %retval = alloca i32, align 4, !llfi_index !95
  %arr = alloca [1000 x i32], align 16, !llfi_index !96
  %n = alloca i32, align 4, !llfi_index !97
  store i32 0, i32* %retval, !llfi_index !98
  %0 = bitcast [1000 x i32]* %arr to i8*, !llfi_index !99
  call void @doProfiling(i32 44)
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %0, i8* bitcast ([1000 x i32]* @_ZZ4mainE3arr to i8*), i64 4000, i32 16, i1 false), !llfi_index !100
  store i32 1000, i32* %n, align 4, !llfi_index !101
  %arraydecay = getelementptr inbounds [1000 x i32]* %arr, i32 0, i32 0, !llfi_index !102
  call void @doProfiling(i32 29)
  %1 = load i32* %n, align 4, !llfi_index !103
  call void @doProfiling(i32 27)
  call void @_Z13insertionSortPii(i32* %arraydecay, i32 %1), !llfi_index !104
  %arraydecay1 = getelementptr inbounds [1000 x i32]* %arr, i32 0, i32 0, !llfi_index !105
  call void @doProfiling(i32 29)
  %2 = load i32* %n, align 4, !llfi_index !106
  call void @doProfiling(i32 27)
  call void @_Z10printArrayPii(i32* %arraydecay1, i32 %2), !llfi_index !107
...
entry:
  call void @__cxx_global_var_init(), !llfi_index !109
