...
if.end:                                           ; preds = %entry
  %1 = load i32** %arr.addr, align 8
  %2 = load i32* %n.addr, align 4
  %sub = sub nsw i32 %2, 1
  call void @_Z22insertionSortRecursivePii(i32* %1, i32 %sub)
...
while.end:                                        ; preds = %land.end
  ...
  %arrayidx13 = getelementptr inbounds i32* %21, i64 %idxprom12
...
entry:
  ...
  call void @_Z22insertionSortRecursivePii(i32* %arraydecay, i32 %1)
