; ModuleID = '/home/Desktop/Work/insert_rec/insert.ll'
...
entry:
  ...
  %cmp = icmp sle i32 %0, 1, !llfi_index !13
  br i1 %cmp, label %if.then, label %if.end, !llfi_index !14

if.then:                                          ; preds = %entry
  br label %return, !llfi_index !15

if.end:                                           ; preds = %entry
  %1 = load i32** %arr.addr, align 8, !llfi_index !16
  %2 = load i32* %n.addr, align 4, !llfi_index !17
  %sub = sub nsw i32 %2, 1, !llfi_index !18
  call void @_Z22insertionSortRecursivePii(i32* %1, i32 %sub), !llfi_index !19
  %3 = load i32* %n.addr, align 4, !llfi_index !20
  %sub1 = sub nsw i32 %3, 1, !llfi_index !21
  %idxprom = sext i32 %sub1 to i64, !llfi_index !22
  %4 = load i32** %arr.addr, align 8, !llfi_index !23
  %arrayidx = getelementptr inbounds i32* %4, i64 %idxprom, !llfi_index !24
  %5 = load i32* %arrayidx, align 4, !llfi_index !25
  store i32 %5, i32* %last, align 4, !llfi_index !26
  %6 = load i32* %n.addr, align 4, !llfi_index !27
  %sub2 = sub nsw i32 %6, 2, !llfi_index !28
  store i32 %sub2, i32* %j, align 4, !llfi_index !29
  br label %while.cond, !llfi_index !30

while.cond:                                       ; preds = %while.body, %if.end
  %7 = load i32* %j, align 4, !llfi_index !31
  %cmp3 = icmp sge i32 %7, 0, !llfi_index !32
  br i1 %cmp3, label %land.rhs, label %land.end, !llfi_index !33

land.rhs:                                         ; preds = %while.cond
  %8 = load i32* %j, align 4, !llfi_index !34
  %idxprom4 = sext i32 %8 to i64, !llfi_index !35
  %9 = load i32** %arr.addr, align 8, !llfi_index !36
  %arrayidx5 = getelementptr inbounds i32* %9, i64 %idxprom4, !llfi_index !37
  %10 = load i32* %arrayidx5, align 4, !llfi_index !38
  %11 = load i32* %last, align 4, !llfi_index !39
  %cmp6 = icmp sgt i32 %10, %11, !llfi_index !40
  br label %land.end, !llfi_index !41

land.end:                                         ; preds = %land.rhs, %while.cond
  %12 = phi i1 [ false, %while.cond ], [ %cmp6, %land.rhs ], !llfi_index !42
  br i1 %12, label %while.body, label %while.end, !llfi_index !43

while.body:                                       ; preds = %land.end
  %13 = load i32* %j, align 4, !llfi_index !44
  %idxprom7 = sext i32 %13 to i64, !llfi_index !45
  %14 = load i32** %arr.addr, align 8, !llfi_index !46
  %arrayidx8 = getelementptr inbounds i32* %14, i64 %idxprom7, !llfi_index !47
  %15 = load i32* %arrayidx8, align 4, !llfi_index !48
  %16 = load i32* %j, align 4, !llfi_index !49
  %add = add nsw i32 %16, 1, !llfi_index !50
  %idxprom9 = sext i32 %add to i64, !llfi_index !51
  %17 = load i32** %arr.addr, align 8, !llfi_index !52
  %arrayidx10 = getelementptr inbounds i32* %17, i64 %idxprom9, !llfi_index !53
  store i32 %15, i32* %arrayidx10, align 4, !llfi_index !54
  %18 = load i32* %j, align 4, !llfi_index !55
  %dec = add nsw i32 %18, -1, !llfi_index !56
  store i32 %dec, i32* %j, align 4, !llfi_index !57
  br label %while.cond, !llfi_index !58

while.end:                                        ; preds = %land.end
  %19 = load i32* %last, align 4, !llfi_index !59
  %20 = load i32* %j, align 4, !llfi_index !60
  %add11 = add nsw i32 %20, 1, !llfi_index !61
  %idxprom12 = sext i32 %add11 to i64, !llfi_index !62
  %21 = load i32** %arr.addr, align 8, !llfi_index !63
  %arrayidx13 = getelementptr inbounds i32* %21, i64 %idxprom12, !llfi_index !64
  store i32 %19, i32* %arrayidx13, align 4, !llfi_index !65
  br label %return, !llfi_index !66
...
entry:
  %arr.addr = alloca i32*, align 8, !llfi_index !68
  %n.addr = alloca i32, align 4, !llfi_index !69
  %i = alloca i32, align 4, !llfi_index !70
  store i32* %arr, i32** %arr.addr, align 8, !llfi_index !71
  store i32 %n, i32* %n.addr, align 4, !llfi_index !72
  store i32 0, i32* %i, align 4, !llfi_index !73
  br label %for.cond, !llfi_index !74

for.cond:                                         ; preds = %for.inc, %entry
  %0 = load i32* %i, align 4, !llfi_index !75
  %1 = load i32* %n.addr, align 4, !llfi_index !76
  %cmp = icmp slt i32 %0, %1, !llfi_index !77
  br i1 %cmp, label %for.body, label %for.end, !llfi_index !78

for.body:                                         ; preds = %for.cond
  %2 = load i32* %i, align 4, !llfi_index !79
  %idxprom = sext i32 %2 to i64, !llfi_index !80
  %3 = load i32** %arr.addr, align 8, !llfi_index !81
  %arrayidx = getelementptr inbounds i32* %3, i64 %idxprom, !llfi_index !82
  %4 = load i32* %arrayidx, align 4, !llfi_index !83
  %call = call %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %4), !llfi_index !84
  %call1 = call %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* %call, i8* getelementptr inbounds ([2 x i8]* @.str, i32 0, i32 0)), !llfi_index !85
  br label %for.inc, !llfi_index !86

for.inc:                                          ; preds = %for.body
  %5 = load i32* %i, align 4, !llfi_index !87
  %inc = add nsw i32 %5, 1, !llfi_index !88
  store i32 %inc, i32* %i, align 4, !llfi_index !89
  br label %for.cond, !llfi_index !90
...
define i32 @main() #2 {
entry:
  %retval = alloca i32, align 4, !llfi_index !92
  %arr = alloca [1000 x i32], align 16, !llfi_index !93
  %n = alloca i32, align 4, !llfi_index !94
  store i32 0, i32* %retval, !llfi_index !95
  %0 = bitcast [1000 x i32]* %arr to i8*, !llfi_index !96
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %0, i8* bitcast ([1000 x i32]* @_ZZ4mainE3arr to i8*), i64 4000, i32 16, i1 false), !llfi_index !97
  store i32 1000, i32* %n, align 4, !llfi_index !98
  %arraydecay = getelementptr inbounds [1000 x i32]* %arr, i32 0, i32 0, !llfi_index !99
  %1 = load i32* %n, align 4, !llfi_index !100
  call void @_Z22insertionSortRecursivePii(i32* %arraydecay, i32 %1), !llfi_index !101
  %arraydecay1 = getelementptr inbounds [1000 x i32]* %arr, i32 0, i32 0, !llfi_index !102
  %2 = load i32* %n, align 4, !llfi_index !103
  call void @_Z8printArrPii(i32* %arraydecay1, i32 %2), !llfi_index !104
...
entry:
  call void @__cxx_global_var_init(), !llfi_index !106
