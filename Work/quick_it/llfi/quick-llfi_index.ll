; ModuleID = '/home/Desktop/Work/quick_it/quick.ll'
...
entry:
  ...
  store i32 %1, i32* %t, align 4, !llfi_index !13
  ...
  %5 = load i32* %t, align 4, !llfi_index !18
...
entry:
  %arr.addr = alloca i32*, align 8, !llfi_index !87
  %l.addr = alloca i32, align 4, !llfi_index !88
  %h.addr = alloca i32, align 4, !llfi_index !89
  %saved_stack = alloca i8*, !llfi_index !90
  %top = alloca i32, align 4, !llfi_index !91
  %p = alloca i32, align 4, !llfi_index !92
  store i32* %arr, i32** %arr.addr, align 8, !llfi_index !93
  store i32 %l, i32* %l.addr, align 4, !llfi_index !94
  store i32 %h, i32* %h.addr, align 4, !llfi_index !95
  %0 = load i32* %h.addr, align 4, !llfi_index !96
  %1 = load i32* %l.addr, align 4, !llfi_index !97
  %sub = sub nsw i32 %0, %1, !llfi_index !98
  %add = add nsw i32 %sub, 1, !llfi_index !99
  %2 = zext i32 %add to i64, !llfi_index !100
  %3 = call i8* @llvm.stacksave(), !llfi_index !101
  store i8* %3, i8** %saved_stack, !llfi_index !102
  %vla = alloca i32, i64 %2, align 16, !llfi_index !103
  store i32 -1, i32* %top, align 4, !llfi_index !104
  %4 = load i32* %l.addr, align 4, !llfi_index !105
  %5 = load i32* %top, align 4, !llfi_index !106
  %inc = add nsw i32 %5, 1, !llfi_index !107
  store i32 %inc, i32* %top, align 4, !llfi_index !108
  %idxprom = sext i32 %inc to i64, !llfi_index !109
  %arrayidx = getelementptr inbounds i32* %vla, i64 %idxprom, !llfi_index !110
  store i32 %4, i32* %arrayidx, align 4, !llfi_index !111
  %6 = load i32* %h.addr, align 4, !llfi_index !112
  %7 = load i32* %top, align 4, !llfi_index !113
  %inc1 = add nsw i32 %7, 1, !llfi_index !114
  store i32 %inc1, i32* %top, align 4, !llfi_index !115
  %idxprom2 = sext i32 %inc1 to i64, !llfi_index !116
  %arrayidx3 = getelementptr inbounds i32* %vla, i64 %idxprom2, !llfi_index !117
  store i32 %6, i32* %arrayidx3, align 4, !llfi_index !118
  br label %while.cond, !llfi_index !119

while.cond:                                       ; preds = %if.end28, %entry
  %8 = load i32* %top, align 4, !llfi_index !120
  %cmp = icmp sge i32 %8, 0, !llfi_index !121
  br i1 %cmp, label %while.body, label %while.end, !llfi_index !122

while.body:                                       ; preds = %while.cond
  %9 = load i32* %top, align 4, !llfi_index !123
  %dec = add nsw i32 %9, -1, !llfi_index !124
  store i32 %dec, i32* %top, align 4, !llfi_index !125
  %idxprom4 = sext i32 %9 to i64, !llfi_index !126
  %arrayidx5 = getelementptr inbounds i32* %vla, i64 %idxprom4, !llfi_index !127
  %10 = load i32* %arrayidx5, align 4, !llfi_index !128
  store i32 %10, i32* %h.addr, align 4, !llfi_index !129
  %11 = load i32* %top, align 4, !llfi_index !130
  %dec6 = add nsw i32 %11, -1, !llfi_index !131
  store i32 %dec6, i32* %top, align 4, !llfi_index !132
  %idxprom7 = sext i32 %11 to i64, !llfi_index !133
  %arrayidx8 = getelementptr inbounds i32* %vla, i64 %idxprom7, !llfi_index !134
  %12 = load i32* %arrayidx8, align 4, !llfi_index !135
  store i32 %12, i32* %l.addr, align 4, !llfi_index !136
  %13 = load i32** %arr.addr, align 8, !llfi_index !137
  %14 = load i32* %l.addr, align 4, !llfi_index !138
  %15 = load i32* %h.addr, align 4, !llfi_index !139
  %call = call i32 @_Z9partitionPiii(i32* %13, i32 %14, i32 %15), !llfi_index !140
  store i32 %call, i32* %p, align 4, !llfi_index !141
  %16 = load i32* %p, align 4, !llfi_index !142
  %sub9 = sub nsw i32 %16, 1, !llfi_index !143
  %17 = load i32* %l.addr, align 4, !llfi_index !144
  %cmp10 = icmp sgt i32 %sub9, %17, !llfi_index !145
  br i1 %cmp10, label %if.then, label %if.end, !llfi_index !146

if.then:                                          ; preds = %while.body
  %18 = load i32* %l.addr, align 4, !llfi_index !147
  %19 = load i32* %top, align 4, !llfi_index !148
  %inc11 = add nsw i32 %19, 1, !llfi_index !149
  store i32 %inc11, i32* %top, align 4, !llfi_index !150
  %idxprom12 = sext i32 %inc11 to i64, !llfi_index !151
  %arrayidx13 = getelementptr inbounds i32* %vla, i64 %idxprom12, !llfi_index !152
  store i32 %18, i32* %arrayidx13, align 4, !llfi_index !153
  %20 = load i32* %p, align 4, !llfi_index !154
  %sub14 = sub nsw i32 %20, 1, !llfi_index !155
  %21 = load i32* %top, align 4, !llfi_index !156
  %inc15 = add nsw i32 %21, 1, !llfi_index !157
  store i32 %inc15, i32* %top, align 4, !llfi_index !158
  %idxprom16 = sext i32 %inc15 to i64, !llfi_index !159
  %arrayidx17 = getelementptr inbounds i32* %vla, i64 %idxprom16, !llfi_index !160
  store i32 %sub14, i32* %arrayidx17, align 4, !llfi_index !161
  br label %if.end, !llfi_index !162

if.end:                                           ; preds = %if.then, %while.body
  %22 = load i32* %p, align 4, !llfi_index !163
  %add18 = add nsw i32 %22, 1, !llfi_index !164
  %23 = load i32* %h.addr, align 4, !llfi_index !165
  %cmp19 = icmp slt i32 %add18, %23, !llfi_index !166
  br i1 %cmp19, label %if.then20, label %if.end28, !llfi_index !167

if.then20:                                        ; preds = %if.end
  %24 = load i32* %p, align 4, !llfi_index !168
  %add21 = add nsw i32 %24, 1, !llfi_index !169
  %25 = load i32* %top, align 4, !llfi_index !170
  %inc22 = add nsw i32 %25, 1, !llfi_index !171
  store i32 %inc22, i32* %top, align 4, !llfi_index !172
  %idxprom23 = sext i32 %inc22 to i64, !llfi_index !173
  %arrayidx24 = getelementptr inbounds i32* %vla, i64 %idxprom23, !llfi_index !174
  store i32 %add21, i32* %arrayidx24, align 4, !llfi_index !175
  %26 = load i32* %h.addr, align 4, !llfi_index !176
  %27 = load i32* %top, align 4, !llfi_index !177
  %inc25 = add nsw i32 %27, 1, !llfi_index !178
  store i32 %inc25, i32* %top, align 4, !llfi_index !179
  %idxprom26 = sext i32 %inc25 to i64, !llfi_index !180
  %arrayidx27 = getelementptr inbounds i32* %vla, i64 %idxprom26, !llfi_index !181
  store i32 %26, i32* %arrayidx27, align 4, !llfi_index !182
  br label %if.end28, !llfi_index !183

if.end28:                                         ; preds = %if.then20, %if.end
  br label %while.cond, !llfi_index !184

while.end:                                        ; preds = %while.cond
  %28 = load i8** %saved_stack, !llfi_index !185
  call void @llvm.stackrestore(i8* %28), !llfi_index !186
...
entry:
  %arr.addr = alloca i32*, align 8, !llfi_index !188
  %n.addr = alloca i32, align 4, !llfi_index !189
  %i = alloca i32, align 4, !llfi_index !190
  store i32* %arr, i32** %arr.addr, align 8, !llfi_index !191
  store i32 %n, i32* %n.addr, align 4, !llfi_index !192
  store i32 0, i32* %i, align 4, !llfi_index !193
  br label %for.cond, !llfi_index !194

for.cond:                                         ; preds = %for.inc, %entry
  %0 = load i32* %i, align 4, !llfi_index !195
  %1 = load i32* %n.addr, align 4, !llfi_index !196
  %cmp = icmp slt i32 %0, %1, !llfi_index !197
  br i1 %cmp, label %for.body, label %for.end, !llfi_index !198

for.body:                                         ; preds = %for.cond
  %2 = load i32* %i, align 4, !llfi_index !199
  %idxprom = sext i32 %2 to i64, !llfi_index !200
  %3 = load i32** %arr.addr, align 8, !llfi_index !201
  %arrayidx = getelementptr inbounds i32* %3, i64 %idxprom, !llfi_index !202
  %4 = load i32* %arrayidx, align 4, !llfi_index !203
  %call = call %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %4), !llfi_index !204
  %call1 = call %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* %call, i8* getelementptr inbounds ([2 x i8]* @.str, i32 0, i32 0)), !llfi_index !205
  br label %for.inc, !llfi_index !206

for.inc:                                          ; preds = %for.body
  %5 = load i32* %i, align 4, !llfi_index !207
  %inc = add nsw i32 %5, 1, !llfi_index !208
  store i32 %inc, i32* %i, align 4, !llfi_index !209
  br label %for.cond, !llfi_index !210
...
define i32 @main() #3 {
entry:
  %retval = alloca i32, align 4, !llfi_index !212
  %arr = alloca [1000 x i32], align 16, !llfi_index !213
  %n = alloca i32, align 4, !llfi_index !214
  store i32 0, i32* %retval, !llfi_index !215
  %0 = bitcast [1000 x i32]* %arr to i8*, !llfi_index !216
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %0, i8* bitcast ([1000 x i32]* @_ZZ4mainE3arr to i8*), i64 4000, i32 16, i1 false), !llfi_index !217
  store i32 1000, i32* %n, align 4, !llfi_index !218
  %arraydecay = getelementptr inbounds [1000 x i32]* %arr, i32 0, i32 0, !llfi_index !219
  %1 = load i32* %n, align 4, !llfi_index !220
  %sub = sub nsw i32 %1, 1, !llfi_index !221
  call void @_Z18quickSortIterativePiii(i32* %arraydecay, i32 0, i32 %sub), !llfi_index !222
  %arraydecay1 = getelementptr inbounds [1000 x i32]* %arr, i32 0, i32 0, !llfi_index !223
  %2 = load i32* %n, align 4, !llfi_index !224
  call void @_Z8printArrPii(i32* %arraydecay1, i32 %2), !llfi_index !225
  ret i32 0, !llfi_index !226
}
...
entry:
  call void @__cxx_global_var_init(), !llfi_index !227
