...
entry:
  ...
  store i32 %fi1, i32* %temp, align 4, !llfi_index !14
  ...
  %5 = load i32* %temp, align 4, !llfi_index !19
...
entry:
  ...
  %fi8 = call i32 @injectFault2(i64 31, i32 %0, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !12
  %idxprom = sext i32 %fi8 to i64, !llfi_index !33
  %fi9 = call i64 @injectFault0(i64 32, i64 %idxprom, i32 35, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !12
  %1 = load i32** %arr.addr, align 8, !llfi_index !34
  %fi10 = call i32* @injectFault1(i64 33, i32* %1, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !12
  %arrayidx = getelementptr i32* %fi10, i64 %fi9, !llfi_index !35
  %fi11 = call i32* @injectFault1(i64 34, i32* %arrayidx, i32 29, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !12
  %2 = load i32* %fi11, align 4, !llfi_index !36
  %fi12 = call i32 @injectFault2(i64 35, i32 %2, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !12
  store i32 %fi12, i32* %x, align 4, !llfi_index !37
  %3 = load i32* %l.addr, align 4, !llfi_index !38
  %fi13 = call i32 @injectFault2(i64 37, i32 %3, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !12
  %sub = sub nsw i32 %fi13, 1, !llfi_index !39
  %fi14 = call i32 @injectFault2(i64 38, i32 %sub, i32 10, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8]* @sub_namestr, i32 0, i32 0)), !llfi_injectfault !12
  store i32 %fi14, i32* %i, align 4, !llfi_index !40
  %4 = load i32* %l.addr, align 4, !llfi_index !41
  %fi17 = call i32 @injectFault2(i64 40, i32 %4, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !12
  store i32 %fi17, i32* %j, align 4, !llfi_index !42
  br label %for.cond, !llfi_index !43

for.cond:                                         ; preds = %for.inc, %entry
  %5 = load i32* %j, align 4, !llfi_index !44
  %fi18 = call i32 @injectFault2(i64 43, i32 %5, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !12
  %6 = load i32* %h.addr, align 4, !llfi_index !45
  %fi19 = call i32 @injectFault2(i64 44, i32 %6, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !12
  %sub1 = sub nsw i32 %fi19, 1, !llfi_index !46
  %fi20 = call i32 @injectFault2(i64 45, i32 %sub1, i32 10, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8]* @sub_namestr, i32 0, i32 0)), !llfi_injectfault !12
  %cmp = icmp sle i32 %fi18, %fi20, !llfi_index !47
  %fi21 = call i1 @injectFault3(i64 46, i1 %cmp, i32 46, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !12
  br i1 %fi21, label %for.body, label %for.end, !llfi_index !48

for.body:                                         ; preds = %for.cond
  %7 = load i32* %j, align 4, !llfi_index !49
  %fi22 = call i32 @injectFault2(i64 48, i32 %7, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !12
  %idxprom2 = sext i32 %fi22 to i64, !llfi_index !50
...
if.then:                                          ; preds = %for.body
  ...
  %fi23 = call i32 @injectFault2(i64 57, i32 %inc, i32 8, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !12
  store i32 %fi23, i32* %i, align 4, !llfi_index !59
  ...
  %fi15 = call i32* @injectFault1(i64 61, i32* %13, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !12
  %arrayidx6 = getelementptr i32* %fi15, i64 %fi25, !llfi_index !63
  %fi16 = call i32* @injectFault1(i64 62, i32* %arrayidx6, i32 29, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !12
  ...
  call void @_Z4swapPiS_(i32* %fi16, i32* %fi29), !llfi_index !68
...
entry:
  %A.addr = alloca i32*, align 8, !llfi_index !88
  %l.addr = alloca i32, align 4, !llfi_index !89
  %h.addr = alloca i32, align 4, !llfi_index !90
  %p = alloca i32, align 4, !llfi_index !91
  store i32* %A, i32** %A.addr, align 8, !llfi_index !92
  store i32 %l, i32* %l.addr, align 4, !llfi_index !93
  store i32 %h, i32* %h.addr, align 4, !llfi_index !94
  %0 = load i32* %l.addr, align 4, !llfi_index !95
  %fi11 = call i32 @injectFault2(i64 94, i32 %0, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !12
  %1 = load i32* %h.addr, align 4, !llfi_index !96
  %fi12 = call i32 @injectFault2(i64 95, i32 %1, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !12
  %cmp = icmp slt i32 %fi11, %fi12, !llfi_index !97
  %fi13 = call i1 @injectFault3(i64 96, i1 %cmp, i32 46, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !12
  br i1 %fi13, label %if.then, label %if.end, !llfi_index !98

if.then:                                          ; preds = %entry
  %2 = load i32** %A.addr, align 8, !llfi_index !99
  %fi = call i32* @injectFault1(i64 98, i32* %2, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !12
  %3 = load i32* %l.addr, align 4, !llfi_index !100
  %fi1 = call i32 @injectFault2(i64 99, i32 %3, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !12
  %4 = load i32* %h.addr, align 4, !llfi_index !101
  %fi2 = call i32 @injectFault2(i64 100, i32 %4, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !12
  %call = call i32 @_Z9partitionPiii(i32* %fi, i32 %fi1, i32 %fi2), !llfi_index !102
  store i32 %call, i32* %p, align 4, !llfi_index !103
  %5 = load i32** %A.addr, align 8, !llfi_index !104
  %fi3 = call i32* @injectFault1(i64 103, i32* %5, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !12
  %6 = load i32* %l.addr, align 4, !llfi_index !105
  %fi4 = call i32 @injectFault2(i64 104, i32 %6, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !12
  %7 = load i32* %p, align 4, !llfi_index !106
  %fi5 = call i32 @injectFault2(i64 105, i32 %7, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !12
  %sub = sub nsw i32 %fi5, 1, !llfi_index !107
  %fi6 = call i32 @injectFault2(i64 106, i32 %sub, i32 10, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8]* @sub_namestr, i32 0, i32 0)), !llfi_injectfault !12
  call void @_Z9quickSortPiii(i32* %fi3, i32 %fi4, i32 %fi6), !llfi_index !108
  %8 = load i32** %A.addr, align 8, !llfi_index !109
  %fi7 = call i32* @injectFault1(i64 108, i32* %8, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !12
  %9 = load i32* %p, align 4, !llfi_index !110
  %fi8 = call i32 @injectFault2(i64 109, i32 %9, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !12
  %add = add nsw i32 %fi8, 1, !llfi_index !111
  %fi9 = call i32 @injectFault2(i64 110, i32 %add, i32 8, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !12
  %10 = load i32* %h.addr, align 4, !llfi_index !112
  %fi10 = call i32 @injectFault2(i64 111, i32 %10, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !12
  call void @_Z9quickSortPiii(i32* %fi7, i32 %fi9, i32 %fi10), !llfi_index !113
  br label %if.end, !llfi_index !114
...
entry:
  ...
  %retval = alloca i32, align 4, !llfi_index !116
  %arr = alloca [1000 x i32], align 16, !llfi_index !117
  %n = alloca i32, align 4, !llfi_index !118
  %i = alloca i32, align 4, !llfi_index !119
  store i32 0, i32* %retval, !llfi_index !120
  %0 = bitcast [1000 x i32]* %arr to i8*, !llfi_index !121
  %fi1 = call i8* @injectFault4(i64 120, i8* %0, i32 44, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([8 x i8]* @bitcast_namestr, i32 0, i32 0)), !llfi_injectfault !12
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %fi1, i8* bitcast ([1000 x i32]* @_ZZ4mainE3arr to i8*), i64 4000, i32 16, i1 false), !llfi_index !122
  store i32 1000, i32* %n, align 4, !llfi_index !123
  %arraydecay = getelementptr [1000 x i32]* %arr, i32 0, i32 0, !llfi_index !124
  %fi2 = call i32* @injectFault1(i64 123, i32* %arraydecay, i32 29, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !12
  %1 = load i32* %n, align 4, !llfi_index !125
  %fi3 = call i32 @injectFault2(i64 124, i32 %1, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !12
  %sub = sub nsw i32 %fi3, 1, !llfi_index !126
  %fi4 = call i32 @injectFault2(i64 125, i32 %sub, i32 10, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8]* @sub_namestr, i32 0, i32 0)), !llfi_injectfault !12
  call void @_Z9quickSortPiii(i32* %fi2, i32 0, i32 %fi4), !llfi_index !127
  store i32 0, i32* %i, align 4, !llfi_index !128
  br label %for.cond, !llfi_index !129

for.cond:                                         ; preds = %for.inc, %entry
  %2 = load i32* %i, align 4, !llfi_index !130
  %fi5 = call i32 @injectFault2(i64 129, i32 %2, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !12
  %3 = load i32* %n, align 4, !llfi_index !131
  %fi6 = call i32 @injectFault2(i64 130, i32 %3, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !12
  %cmp = icmp slt i32 %fi5, %fi6, !llfi_index !132
  %fi7 = call i1 @injectFault3(i64 131, i1 %cmp, i32 46, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !12
  br i1 %fi7, label %for.body, label %for.end, !llfi_index !133

for.body:                                         ; preds = %for.cond
  %4 = load i32* %i, align 4, !llfi_index !134
  %fi8 = call i32 @injectFault2(i64 133, i32 %4, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !12
  %idxprom = sext i32 %fi8 to i64, !llfi_index !135
  %fi9 = call i64 @injectFault0(i64 134, i64 %idxprom, i32 35, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !12
  %arrayidx = getelementptr [1000 x i32]* %arr, i32 0, i64 %fi9, !llfi_index !136
  %fi10 = call i32* @injectFault1(i64 135, i32* %arrayidx, i32 29, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !12
  %5 = load i32* %fi10, align 4, !llfi_index !137
  %fi = call i32 @injectFault2(i64 136, i32 %5, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !12
  %call = call %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %fi), !llfi_index !138
  %call1 = call %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* %call, i8* getelementptr inbounds ([2 x i8]* @.str, i32 0, i32 0)), !llfi_index !139
  br label %for.inc, !llfi_index !140

for.inc:                                          ; preds = %for.body
  %6 = load i32* %i, align 4, !llfi_index !141
  %fi11 = call i32 @injectFault2(i64 140, i32 %6, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !12
  %inc = add nsw i32 %fi11, 1, !llfi_index !142
  %fi12 = call i32 @injectFault2(i64 141, i32 %inc, i32 8, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !12
  store i32 %fi12, i32* %i, align 4, !llfi_index !143
  br label %for.cond, !llfi_index !144
...
entry:
  call void @__cxx_global_var_init(), !llfi_index !146
