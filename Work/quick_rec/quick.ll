...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [1000 x i32]* %arr, i32 0, i64 %idxprom
  %5 = load i32* %arrayidx, align 4
  %call = call %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %5)
